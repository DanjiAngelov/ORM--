...
namespace ORM_HW_1
{
    internal class Program
    {
        ...
        {
            string connectionString = "Server= DESKTOP-S33H9D5;Trusted_Connection=true;TrustServerCertificate=true";
            ...
            connectionString = $"Server = DESKTOP-S33H9D5;Database={database};Trusted_Connection = true; TrustServerCertificate = true";
